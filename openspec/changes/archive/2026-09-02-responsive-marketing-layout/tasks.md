...
- [x] 1.1 Звірити нав хедера без Прокат/Артефактів
...
- [x] 1.2 Звірити токени капсул у working tree
...
- [x] 1.3 Звірити капсулу «Актуальні події»
...
- [x] 1.5 Звірити прозорий логотип Danish
...
- [x] 2.1 Оголосити токени 1280 / 768
  Files: src/styles/tokens.css
...
- [x] 2.2 SiteLayout без phone-стеку до 768
...
- [x] 2.4 Логотип хедера на вузьких екранах
...
- [x] 2.5 Глобальний `.site-stack` лише на phone
  Files: src/style.css
...
- [x] 3.1 HomePage: 1280 ряд, 768 2-колонки, <768 стопка
...
- [x] 3.2 Медіа капсули подій під 768
  Files: src/components/home/HomeCapsuleEvents.vue
...
- [x] 3.3 Медіа капсули проєктів під 768
  Files: src/components/home/HomeCapsuleProjects.vue
...
- [x] 4.1 Кільце hover на хіт-зоні плитки
...
- [x] 4.2 Стек плиток лише на phone
...
- [x] 5.1 Ряди проєктів: 2 колонки до 768
...
- [x] 5.5 Майстерня, army-support, події, благодійність — padding без порогу 1727
